...
alias lback='touch /myphp/leaderfit/leaderfit/store/Ekom/database/kamille.sql; /Applications/MAMP/Library/bin/mysqldump -u root -proot kamille > /myphp/leaderfit/leaderfit/store/Ekom/database/kamille.sql'

...
alias xiaotracker='php -f "/myphp/leaderfit/leaderfit/scripts/xiao-kamille-module-generator.php" --  --module=EkomUserTracker --prefix=eut_'
alias xiaofsearch='php -f "/myphp/leaderfit/leaderfit/scripts/xiao-kamille-module-generator.php" --  --module=EkomFastSearch --prefix=ekfs_'

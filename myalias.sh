...
alias lback='/Applications/MAMP/Library/bin/mysqldump -u root -proot kamille > /myphp/leaderfit/leaderfit/store/Ekom/database/kamille.sql; open /myphp/leaderfit/leaderfit/store/Ekom/database;'
